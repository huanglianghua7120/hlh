...
public class Mo implements java.io.Serializable {
    ...
    public Mo(java.lang.String addSerial, java.lang.String addSerialRev, java.lang.String channelnumber, java.lang.String mobileNumber, java.lang.String sentTime,
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        ...
        boolean equals;
        equals =
                true && ((this.addSerial == null && other.getAddSerial() == null) || (this.addSerial != null && this.addSerial.equals(other.getAddSerial()))) && ((this.addSerialRev ==
                                                                                                                                                                   null &&
                                                                                                                                                                   other.getAddSerialRev() ==
                                                                                                                                                                   null) ||
                                                                                                                                                                  (this.addSerialRev !=
                                                                                                                                                                   null &&
    ...
    public synchronized int hashCode() {
        ...
        if (getAddSerial() != null) {
            hashCode += getAddSerial().hashCode();
        }
        if (getAddSerialRev() != null) {
            hashCode += getAddSerialRev().hashCode();
        }
        if (getChannelnumber() != null) {
            hashCode += getChannelnumber().hashCode();
        }
        if (getMobileNumber() != null) {
            hashCode += getMobileNumber().hashCode();
        }
        if (getSentTime() != null) {
            hashCode += getSentTime().hashCode();
        }
        if (getSmsContent() != null) {
            hashCode += getSmsContent().hashCode();
        }
        hashCodeCalc = false;
        return hashCode;
    }
