...
//package com.message.shortmessage.yimei.service;
//
//
//import com.base.adf.common.utils.SToolUtils;
//
//import com.message.api.utils.SaafToolUtils;
//import com.message.shortmessage.utils.Mo;
//import com.message.shortmessage.utils.StatusReport;
//
...
//
//@Component("testSDKClient")
//public class TestSDKClient {
//
//    public static String softwareSerialNo = "8SDK-EMY-6699-RERUO "; // 软件序列号,请通过亿美销售人员获取
//    public static String key = "429801"; // 序列号首次激活时自己设定
//    public static String password = "429801"; // 密码,请通过亿美销售人员获取
//    @Autowired
//    private Client client;
//    public static void main(String[] args) {
//        TestSDKClient testSDKClient = (TestSDKClient)SaafToolUtils.context.getBean("testSDKClient");
//        /**
//		 * 获取client的方法1 此示例中用SDKclient获取到Client对象,
//		 * 您也可以用Client(softwareSerialNo,password)获取一个Client对象
//		 * 注:使用SDKclient获取到Client对象的序列号及密码在config.properties中配置
//		 */
...
//        //                testRegistEx();
//        //        testSendSMS();
//        testSDKClient.testGetBalance();
//        /*try {
//            StartMenu();
//            while (true) {
//                LOGGER.info("请输入序号进行操作");
...
//        int i = 1;
//        LOGGER.info(i + "、激活序列号,初次使用、已注销后再次使用时调用该方法.");
//        i += 1;
//        LOGGER.info(i + "、企业信息注册,目地在于短信发送异常时Emay可以连系到企业.");
//        i += 1;
//        LOGGER.info(i + "、余额查询");
//        i += 1;
//        LOGGER.info(i + "、充值");
...
//        LOGGER.info(i + "、密码修改");
//        i += 1;
//        LOGGER.info(i + "、发送即时短信");
//        i += 1;
//        LOGGER.info(i + "、发送定时短信");
//        i += 1;
//        LOGGER.info(i + "、发送带有信息ID的短信,可供查询状态报告");
//        i += 1;
//        LOGGER.info(i + "、获取上行短信");
//        i += 1;
//        LOGGER.info(i + "、获得下行短信状态报告");
//        i += 1;
//        LOGGER.info(i + "、发送语音验证码");
//        i += 1;
//        LOGGER.info(i + "、软件注销");
//        i += 1;
//        LOGGER.info(i + "、关闭程序");
...
//        try {
//            int i = client.sendShortMessage(new String[] { "15070398370" }, "测试1号", "", 5); // 带扩展码
//            LOGGER.info("testSendSMS=====" + i);
//        } catch (Exception e) {
//            LOGGER.error(e.getMessage(), e);
//        }
//    }
...
//     */
//    public void testSendScheduledSMS() {
//        try {
//            int i = client.sendScheduledSMSEx(new String[] { "15000000000" }, "异步内容", "20110430174830", "GBK");
//            LOGGER.info("testsSendScheduledSMS=====" + i);
//        } catch (Exception e) {
//            LOGGER.error(e.getMessage(), e);
//        }
//    }
...
//     */
//    public void testSendSMSAddMessageId() {
//        try {
//            int i = client.sendSMSEx(new String[] { "15000000000" }, "带有信息ID的短信", "", "GBK", 5, 123456789);
//            LOGGER.info("testsSendScheduledSMS=====" + i);
//        } catch (Exception e) {
//            LOGGER.error(e.getMessage(), e);
//        }
...
//        try {
//            String value = client.sendVoice(new String[] { "15000000000" }, "123456", "", "GBK", 5, System.currentTimeMillis());
//            LOGGER.info("testsSendVoice=====" + value);
//        } catch (Exception e) {
//            LOGGER.error(e.getMessage(), e);
//        }
//    }
...
//        try {
//
//            int a = client.registDetailInfo("企业名称", "联系人", "01058750425", "13000000000", "sjfkls@yahoo.cn", "01058750500", "企业地址", "056900");
//            LOGGER.info("testRegistDetailInfo:" + a);
//        } catch (Exception e) {
//            LOGGER.error(e.getMessage(), e);
//        }
//    }
...
//        try {
//            int a = client.serialPwdUpd("123456", password);
//            LOGGER.info("testSerialPwdUpd:" + a);
//        } catch (Exception e) {
//            LOGGER.error(e.getMessage(), e);
//        }
//    }
...
//        try {
//            List<Mo> a = client.getMO();
//
//            if (a != null) {
//                LOGGER.info("testGetMO1size:" + a.size());
//                Iterator<Mo> it = a.iterator();
//
//                while (it.hasNext()) {
//                    Mo m = it.next();
//                    // 实例代码为直接输出
//                    LOGGER.info("短信内容:" + m.getSmsContent());
//                    LOGGER.info("通道号:" + m.getChannelnumber());
//                    LOGGER.info("手机号:" + m.getMobileNumber());
//                    LOGGER.info("附加码:" + m.getAddSerialRev());
//                    LOGGER.info("附加码:" + m.getAddSerial());
//                    // 上行短信务必要保存,加入业务逻辑代码,如：保存数据库，写文件等等
//                }
//            } else {
//                LOGGER.info("NO HAVE MO");
//            }
//        } catch (Exception e) {
//            LOGGER.error(e.getMessage(), e);
//        }
...
//                    LOGGER.info("手机号码:" + report.getMobile() + "\t状态:" + report.getReportStatus() + "\t信息ID：" + report.getSeqID());
//                }
//            } else {
//                LOGGER.info("no have data");
//            }
//        } catch (Exception e) {
//            LOGGER.error(e.getMessage(), e);
//        }
