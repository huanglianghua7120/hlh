...
import saaf.common.fmw.message.shortmessage.yimei.client.SDKClient;
import saaf.common.fmw.message.shortmessage.yimei.client.SDKService;
...
@Component("yiMeiSDKLocatorService")
public class YiMeiSDKLocatorService extends org.apache.axis.client.Service implements SDKService {

    public YiMeiSDKLocatorService() {
    }
    @Autowired
    private ShortMessageServer shortMessageServer;

    public YiMeiSDKLocatorService(org.apache.axis.EngineConfiguration config) {
        super(config);
    }

    public YiMeiSDKLocatorService(java.lang.String wsdlLoc, javax.xml.namespace.QName sName) throws javax.xml.rpc.ServiceException {
        super(wsdlLoc, sName);
    }
    public java.lang.String getSDKServiceAddress() {
        return shortMessageServer.queryServerInfo().get(ShortMessageServer.URL);
    }
    ...
    public SDKClient getSDKService() throws javax.xml.rpc.ServiceException {
        ...
        try {
            endpoint = new java.net.URL( shortMessageServer.queryServerInfo().get(ShortMessageServer.URL));
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (SDKClient.class.isAssignableFrom(serviceEndpointInterface)) {
                SDKServiceBindingStub _stub = new SDKServiceBindingStub(new java.net.URL( shortMessageServer.queryServerInfo().get("url")), this);
                _stub.setPortName(getSDKServiceWSDDServiceName());
                return _stub;
            }
