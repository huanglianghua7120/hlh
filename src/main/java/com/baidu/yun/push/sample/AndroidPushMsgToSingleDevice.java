...
public class AndroidPushMsgToSingleDevice {
	public static void main(String[] args) throws PushClientException,
		...
		String apiKey = "L1tdqG5iVyc2RAeOmytT8HZZ";
		String secretKey = "FyHgdmDcqLEryMjEOG8XvbvdreFOq7Q8";
		...
		try {
			...
			notification.put("title", "广州测试天气");
			notification.put("description","广州很好，羊城通");
			...
			PushMsgToSingleDeviceRequest request = new PushMsgToSingleDeviceRequest()
					.addChannelId("3558167010460962849")
